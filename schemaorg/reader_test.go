...
func TestFetch(t *testing.T) {
	...
	testCases := []testCase{
		//{id: "https://blog.front-matter.io/posts/eating-your-own-dog-food"},
		//{id: "https://www.zenodo.org/records/1196821"},
		//{id: "10.1594/pangaea.836178", url: "https://doi.pangaea.de/10.1594/PANGAEA.836178"},
		//{url: "https://dataverse.harvard.edu/dataset.xhtml?persistentId=doi:10.7910/DVN/NJ7XSO"},
